...
<html lang="en">
  ...
  <body>
    <div class="navbar">
      ...
      <div class="nav-item">
        <a class="nav_menu" href="#">Blog</a>
        <a class="nav_menu" href="#">Upload</a>
        <a class="nav_menu" href="#">Notification</a>
        <a class="nav_menu" href="#">Login</a>
      </div>
      <div class="icons">
        <i class="fas fa-user"><span class="icon_user"><?php echo $_SESSION['username'] ?></span></i>
      </div>
    </div>
